...
class KlinikViewEdit : AppCompatActivity() {
    ...
    lateinit var adapter: ViewKlinikEdit
...
//        setContentView(R.layout.activity_daftar_klinik)
        ...
        val dialogView = layoutInflater.inflate(R.layout.activity_klinik_view_edit, null)
        ...
        dbRef.child("dokter").addValueEventListener(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()){
                    ...
                    klinikRecyclerView.adapter = ViewKlinikEdit(klinikArrayList)
                }
            }
